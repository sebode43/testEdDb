...
namespace Test {
    ...
    services.AddDbContext<TestContext>(options => {
        ...
        options.UseSqlServer(Configuration.GetConnectionString("TestEdDb"));
        });
            services.AddCors(option =>
            option.AddPolicy(DefaultCorsPolicy, x => x.WithOrigins(AllowOrigins).WithMethods(AllowMethods).AllowAnyHeader()));
        }
